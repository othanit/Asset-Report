...
namespace ptt_report.App_Code
{
    public class ilipigDLL
    {
        ...
        public void UpdateStatus_Reject(string mas_rep_id, string update_id)
        {
            ...
            strSQL = "  update tblquarter_rep set  internal_status = 'Reject',update_date = getdate(),update_id = '" + update_id + "' where id = '" + mas_rep_id + "' and internal_status in ('Assign','In Process');  " +
