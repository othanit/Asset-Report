...
namespace ptt_report.App_Code
{
    public class FreeSpanDLL
    {
        ...
        public void UpdateStatus_Reject(string mas_rep_id, string update_id)
        {
            ...
            strSQL = "  update tblquarter_rep set  pm_cm_status = 'Reject',update_date = getdate(),update_id = '" + update_id + "' where id = '" + mas_rep_id + "' and pm_cm_status in ('Assign','In Process');  " +
