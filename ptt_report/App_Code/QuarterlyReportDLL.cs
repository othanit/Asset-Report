...
namespace ptt_report.App_Code
{
    public class QuarterlyReportDLL
    {
        ...
        public DataTable GetHistoryLinkByIdDelete(string id)
        {
            ...
            strSQL = " select * from dbo.tblquarter_rep WHERE id = " + id + " and exe_status  in ('Assign','In Process') and pm_cm_status in ('Assign','In Process') and external_status in ('Assign','In Process') and internal_status in ('Assign','In Process') " +
                " and piping in ('Assign','In Process') and offshore in ('Assign','In Process') and other_pro in ('Assign','In Process') ";
        ...
        public void delete_tblquarter_rep(string id)
        {
            ...
            strSQL = "delete dbo.tblquarter_rep WHERE id = " + id + " and exe_status  in ('Assign','In Process') and pm_cm_status in ('Assign','In Process') and external_status in ('Assign','In Process') and internal_status in ('Assign','In Process') " +
                " and piping in ('Assign','In Process') and offshore in ('Assign','In Process') and other_pro in ('Assign','In Process') ";
